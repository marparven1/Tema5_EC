...
hist(resulboot$t-resulboot$t0, # hacemos la diferencia a la hora de representar
     br=30,col="lightblue",prob=TRUE, 
     main=paste(B,"muestras bootstrap (boot)"), xlab="PE1*-PE1",ylab="")
...
```{r}
boot.ci(Tbootresi, conf=1-alfa, type=c("norm","perc","stud","bca"), 
        var.t = Tbootresi$t[,2])
```
